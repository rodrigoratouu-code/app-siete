          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-10 -right-5 md:-bottom-12 md:-right-10 card-glass p-5 max-w-[280px] text-center animate-pulse-slow border-[#FF007F]/40 shadow-[0_0_15px_rgba(255,0,127,0.3)] z-20">
              ...
              <div className="space-y-1 mb-3">
                ...
                <p className="text-[#FF007F] text-[10px] font-semibold tracking-wider">rodrigorato.uu@gmail.com</p>
              </div>
              <div className="flex justify-center gap-3">
                ...
                <a href="mailto:rodrigorato.uu@gmail.com" target="_blank" rel="noreferrer" className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#00F0FF]/20 hover:text-[#00F0FF] transition-colors text-white/70">
